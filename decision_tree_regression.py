...
test_accuaracy_of_overfitmodel=r2_score(y_pred_with_overfit_model,y_test)
...
test_accuracy_of_pre_prunned_model=r2_score(y_pred_wiht_pre_prunned_model,y_test)
...
for i in range(0,len(best_alphas),1):
    ...
    r_Square_score=r2_score(y_pred,y_test)
...
test_accuracy_of_post_prunned_model=r2_score(y_pred_wiht_post_prunned_model,y_test)
...
#here psot prunned model shows more accuracy bcz of the htype of dataset the dataset contains only 350 row  which is samall
